<template>
  <div class="betRecord">
        ...
        <div class="card">
          ...
          <div class="card-row">
            <div class="bet-platform col">
              ...
              <p class="card-font card-font-light">{{ data.gameId }}</p>
            </div>
            <div class="bet-money col">
              <p class="card-font">{{ $t("Bet") }}</p>
              <p class="card-font card-font-light">{{ data.betAmount | $currency }}</p>
            </div>
          </div>
          <div class="card-row">
            <div class="col">
            ...
            <div class="bet-result col">
              ...
              <p class="card-font-large blue">{{ data.result }}</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <transition name="pop">
      <keep-alive>
        <record-filter v-if="isFilter" :gameList="true" @confirm="confirm"></record-filter>
      </keep-alive>
    </transition>
  </div>
</template>
