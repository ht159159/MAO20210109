<template>
  <div class="personal">
    ...
    <div class="scroll">
      <ul class="menu">
        <li class="list">
          ...
          <div class="list-r">
            <div class="list-r-text list-r-text-blue">{{ personalInfo.userName }}</div>
        ...
        <li class="list">
          ...
          <div class="list-r">
            <div
              ...
              :readonly="!editable"
              :unselectable="editable ? '' : 'on'"
            >{{ personalInfo.mobile | $maskPhone}}</div>
            <div class="list-r-icon"></div>
          </div>
        </li>
      </ul>
      ...
      <p class="alert" v-if="!editable">{{ $t("Not_Allow_Change_Personal") }}</p>
    ...
    >
      ...
      <template #btn>
        <div class="alert-box-cancel alert-box-btn" @click="closeModal">{{ $t("Cancel") }}</div>
        <div
...
export default {
  ...
  methods: {
    ...
    confirmData() {
      let { email, realName, gender, birhdate } = this.personalInfo;
      if (!email || !realName || !birhdate || !gender ) {
      ...
      return { email, realName, gender, birhdate,  canEdit: true };
    },
    editPhoneNumber() {
      if (!this.editable) {
        return;
